        ...
        if (isset($_POST['input-location'])){
           ...
           if ($input_role_manager == NULL && $input_role_gmanager == NULL && $input_role_director == NULL && $input_role_director_2 == NULL) {
            ...
            //case sales barat gak punya spv, tp ngisi manager, gmanager, direktur 1, direktur 2 (sip dah bisa juga)
              ...
              //case input spv, manager, direktur 1
            else if ($input_role_gmanager == NULL && $input_role_director_2 == NULL) {

                $insertQueryString = "INSERT INTO report (
                    upload_at, location, attachment, note, report_by, 
                    need_approval_by, need_approval_by_2, need_approval_by_4, 
                    longitude, latitude, project, city, visit_number, 
                    prospect, chance, competitor, deadline, sales_note
                ) VALUES (
                    " . parseTimestampsToSQL() . ", 
            ...
            //case spv, manager, dir 2
             else if ($input_role_gmanager == NULL && $input_role_director == NULL) {

                $insertQueryString = "INSERT INTO report (
                    upload_at, location, attachment, note, report_by, 
                    need_approval_by, need_approval_by_2, need_approval_by_5, 
                    longitude, latitude, project, city, visit_number, 
                    prospect, chance, competitor, deadline, sales_note
                ) VALUES (
                    " . parseTimestampsToSQL() . ", 
            ...
            //case spv, manager, dir 1, dir 2
            else if ($input_role_gmanager == NULL) {

                $insertQueryString = "INSERT INTO report (
                    upload_at, location, attachment, note, report_by, 
                    need_approval_by, need_approval_by_2, need_approval_by_4, need_approval_by_5, 
                    longitude, latitude, project, city, visit_number, 
                    prospect, chance, competitor, deadline, sales_note
                ) VALUES (
                    " . parseTimestampsToSQL() . ", 
            ...
            if (checkSession()) {
                ...
                exit();
            } else if (checkSessionRole(["sales", "manager", "gmanager", "supervisor"])) {
