<?php 
    ...
    function fetchReports($connDB){
        $queryString = "SELECT * FROM full_report";
    ...
    //Page Constructor
    $users = fetchUsers($connDB);
    $reports = fetchReports($connDB);
?>
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item py-3">
                                <form method="GET" action="admin_dashboard.php">
                                    <button type="submit" class="btn btn-danger">Dashboard Sales Report</button>
                                </form>
                        </li>
                        <li class="nav-item">
