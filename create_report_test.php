    ...
    if(checkSession() && checkSessionRole(["sales", "supervisor", "manager", "gmanager"])){
        if (isset($_POST['input-location'])){
            ...
            if($input_role_spv != NULL){
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", '".$input_role_spv."', '".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
            //jika hanya mengisi manager
            else if($input_role_manager != NULL){
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by_2, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", '".$input_role_manager."', '".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
            //jika hanya mengisi gmanager
            else if($input_role_gmanager != NULL){
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by_3, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", '".$input_role_gmanager."', '".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
            //jika hanya mengisi direktur 1
            else if($input_role_director != NULL){
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by_4, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", '".$input_role_director."', '".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
            //jika hanya mengisi direktur 2
            else if($input_role_director_2 != NULL){
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by_5, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", '".$input_role_director_2."', '".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
            //jika mengisi direktur 1 dan 2
            else if($input_role_director != NULL && $input_role_director_2 != NULL){
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by_4, need_approval_5, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", '".$input_role_director."', '".$input_role_director_2."', '".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
            //case sales barat gak punya spv, tapi ngisi manager, gmanager, direktur 1
                ...
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by_2, need_approval_by_3, need_approval_by_4, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", ".$input_role_manager.", ".$input_role_gmanager.", ".$input_role_director.",'".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
            ...
            //case isi manager dan direktur 1 aja
                ...
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by_2, need_approval_by_4, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", ".$input_role_manager.", ".$input_role_director.",'".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
             //case isi manager dan direktur 1 dan 2 aja
                ...
                $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by_2, need_approval_by_4, need_approval_by_5, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", ".$input_role_manager.", ".$input_role_director.", ".$input_role_director_2.",'".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
            }
            //jika mengisi semua atasan
            else{
               $insertQueryString = "INSERT INTO full_report (upload_at, location, attachment, note, report_by, need_approval_by, need_approval_by_2, need_approval_by_3, need_approval_by_4, need_approval_5, longitude, latitude, project, city, visit_number, prospect, chance, competitor, deadline, sales_note) VALUES (".parseTimestampsToSQL().",'".$location."','".$attachment."', '".$note."', ".strval($_SESSION['ID']).", ".$input_role_spv.", ".$input_role_manager.", ".$input_role_gmanager.", ".$input_role_director.", ".$input_role_director_2.", '".$longitude."', '".$latitude."', '".$project."', '".$city."', ".$visit_number.", ".$prospect.", ".$chance.", '".$competitor."', STR_TO_DATE('".$deadline."', '%d/%m/%Y'), '".$sales_note."')";
