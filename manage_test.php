...
<html>
    ...
    <body class="bg-main">
        ...
        <div class="card mt-5 mb-5">
            ...
            <div class="card-body">
                <div class="row">
                    <form id="dynamic-form" method="POST" action="create.php">
                        <button type="button" id="add-activity" class="btn btn-dark">Tambah Aktivitas</button>
...
<script>
    ...
    function addField() {
        ...
        newField.innerHTML = `
                <div class="row">
                    ...
                    <div class="col-6 mb-3">
                     ...
                     <div class="col">
                        <button onclick="addField(), remove(this)" class="btn btn-dark">Tambah</button>
                        <button onclick="removeField()" type="button" class="btn btn-danger">Hapus</button>
                    </div>
                </div>
            `;
     ...
     function removeField() {
        document.removeChild('form-container');
