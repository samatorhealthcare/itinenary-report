                                    ...
                                    <div class="col-6 mb-3">
                                        <label for="select-lapor-ke" class="form-label mb-0 fw-bold">Nama</label>
                                                ...
                                                <select name="input-reports-to-lead-5" class="form-select" id="5-select-lapor-ke">
                                                    <?php if( $user['reports_to_lead_5'] == 0) { ?>
                                                        <option value="" hidden disabled>-</option>
                                                        <?php foreach($director_2 as $temp) { ?>
                                                            <?php if($report_director_2['id'] == $temp['reports_to_lead_5']) { ?>
                                                                <option value="<?= $report_director_2['id']; ?>" class="<?="5-option-lapor-ke role-" . $report_director_2['role'];?>" style="display: none;" selected><?= $report_director_2['username']; ?></option>
                                                                <?php } else { ?>
